...
typedef NS_ENUM(NSUInteger, CYAxisType) {
    CYAxisTypeHorizontal,
    CYAxisTypeVertical
};

@interface NSArray (CYAdditions)

/**
 *  Creates a CYConstraintMaker with each view in the callee.
